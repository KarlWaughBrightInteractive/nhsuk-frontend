...
The application generates static HTML pages to preview components, with each component having their own page, these files can be found in `app/`. If you want to make changes to these components, you will have to edit the individual components within `packages/`. These are usually the only 2 folders that you will need.
